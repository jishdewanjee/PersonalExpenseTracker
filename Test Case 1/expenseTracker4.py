...
class ExpenseTracker:
    ...
    def ValidateExpenseData(self, date_str: str, category: str, amount_str: str, description: str) -> Optional[str]:
        ...
        #if not date_str or not category or not amount_str or not description:### changing this reeal quick to only date_str, and amount_str
    ...
    def DeleteExpense(self) -> None:
        ...
        # Always show current expenses first
        self.ViewExpenses()
