...
class ExpenseTracker:
    ...
    def getValidDate(self):
        """Prompt until user enters a valid YYYY-MM-DD date or 'q' to quit."""
        while True:
            ...
            try:
                ...
                print("⚠️ Invalid date format. Please use YYYY-MM-DD (e.g., 2025-10-28).")

    def getValidAmount(self):
        """Prompt until user enters a valid positive number or 'q' to quit."""
        while True:
            ...
            try:
                ...
                print("⚠️ Please enter a valid number (e.g., 25.50).")
    ...
    def addExpense(self):
        ...
        c = input("Category (optional): ").strip()
        a = self.getValidAmount()
        if a is None:
            print("Returning to main menu.")
            return
